...
import com.isitechproject.easycardwallet.model.service.impl.PictureServiceImpl
...
abstract class ServiceModule {
    ...
    @Binds abstract fun provideUserDataService(impl: UserDataServiceImpl): UserDataService
    ...
    @Binds abstract fun providePictureService(impl: PictureServiceImpl): PictureService
}